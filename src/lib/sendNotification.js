...
//
// Calls the /api/send-notification Vercel function (see
// api/send-notification.js) — this REPLACES what used to happen
// automatically via Firebase Cloud Functions' Firestore triggers (which
// need the paid Blaze plan). Since Vercel has no equivalent trigger, this
// must be called explicitly, right after the action that should notify
// someone (creating a match request, sending a message, accepting a join
// request, etc.) — see where this is called from in MatchFinder.jsx,
// MatchChat.jsx, SkillSwap.jsx, EventBuddy.jsx.
//
